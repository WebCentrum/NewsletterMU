	...
	<head>
		...
		<?php
			...
			if ($_GET['color']) {
				if ($_GET['color'] == 'law'){
					$color = '#7f379b';
					$colorLight = adjustBrightness($color, 125);
					$colorBorder = adjustBrightness($color, 175);
				}
				if ($_GET['color'] == 'med'){
					$color = '#f01928';
					$colorLight = adjustBrightness($color, 125);
				...
				if ($_GET['color'] == 'fi'){
					$color = '#f2d45c';
					$colorLight = '#999';
					$colorBorder = adjustBrightness($color, 100);
				}
				if ($_GET['color'] == 'fss'){
					$color = '#007b69';
					$colorLight = '#5bb4a7';
				...
				if ($_GET['color'] == 'econ'){
					$color = '#782328';
					$colorLight = adjustBrightness($color, 125);
					$colorBorder = adjustBrightness($color, 200);
				}
						...
						<tr class="sk-block">
							<td class="sk-block">
								...
								<table class="sk-block-table-all" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
									<tr>
										<td class="sk-pb40" style="padding: 0 0 60px;">
											<table dir="rtl" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left; background: <?php echo $color; ?>;">
												<tr>
																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
																		<tr>
																			<td style="padding: 0 0 20px;">
																				<div><!--[if mso]>
																				  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:32px;v-text-anchor:middle;width:140px;" strokecolor="#ffffff" strokeweight="2px" fillcolor="<?php echo $color; ?>">
																					<w:anchorlock/>
								...
								<table class="sk-block-table-all" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
									<tr>
										<td class="sk-pb40" style="padding: 0 0 60px;">
											<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left; background: <?php echo $color; ?>;">
												<tr>
														...
														<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
															<tr>
																<td class="sk-pl20 sk-pr20 sk-pt20" style="color: #444; padding: 25px 30px 10px; border: 1px solid #ddd; border-top: 3px solid <?php echo $color; ?>;">
																	<p style="text-transform: uppercase; font-size: 12px; line-height: 18px; color: <?php echo $colorLight; ?>; margin: 0 0 3px;">
																		Vzdělávání
																	</p>
																			...
																			<td style="padding: 0 0 20px;">
																				<div><!--[if mso]>
																				  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:32px;v-text-anchor:middle;width:140px;" strokecolor="<?php echo $color; ?>" strokeweight="2px" fillcolor="#ffffff">
																					<w:anchorlock/>
																					<center style="color:<?php echo $color; ?>;font-family:sans-serif;font-size:12px;text-transform: uppercase;">Celý článek</center>
																				  </v:rect>
																				<![endif]--><a href="#" style="border:2px solid <?php echo $color; ?>;color:<?php echo $color; ?>;display:inline-block;font-family:sans-serif;font-size:12px;text-transform: uppercase;line-height:32px;text-align:center;text-decoration:none;width:140px;-webkit-text-size-adjust:none;mso-hide:all;">Celý článek</a></div>
																			</td>
																		</tr>
																	</table>
																</td>
														...
														<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
															<tr>
																<td class="sk-pl20 sk-pr20 sk-pt20" style="color: #444; padding: 25px 30px 10px; border: 1px solid #ddd; border-top: 3px solid <?php echo $color; ?>;">
																	...
																	<h2 style="font-size: 24px; line-height: 32px; font-family: Tahoma, Verdana, sans-serif; color: <?php echo $color; ?>; margin: 0 0 20px;">
																		<a href="#" style="text-decoration: none; color: <?php echo $color; ?>;">
														...
														<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
															<tr>
																<td class="sk-pl20 sk-pr20 sk-pt20" style="color: #444; padding: 25px 30px 10px;">
																	...
																	<h2 style="font-size: 24px; line-height: 35px; font-family: Tahoma, Verdana, sans-serif; color: <?php echo $color; ?>; margin: 0 0 20px;">
																		<a href="#" style="text-decoration: none; color: <?php echo $color; ?>;">
																			V Univerzitním kině Scala bude obchod s reklamními předměty
																		</a>
																	</h2>
								...
								<table class="sk-block-table-all" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
									<tr>
										<td class="sk-pl20 sk-pr20" style="padding: 0 0 30px;">
											<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
												<tr>
													<td style="border-bottom: 3px solid <?php echo $colorBorder; ?>;">
														<h2 style="font-size: 24px; line-height: 35px; font-family: Tahoma, Verdana, sans-serif; color: <?php echo $color; ?>; margin: 0 0 10px;">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
									<tr>
										<td class="sk-pb40 sk-pl20 sk-pr20" style="padding: 0 0 60px;">
											<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
												<tr>
													<td style="border-bottom: 3px solid <?php echo $colorBorder; ?>; padding: 0 0 30px;">
														<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
															<tr>
																<td style="color: <?php echo $color; ?>; vertical-align: top; padding: 15px 15px 15px 0;">
																	<p style="line-height: 24px; margin: 0;">
																		MU
																	</p>
																</td>
																<td style="color: <?php echo $color; ?>; vertical-align: top; padding: 15px 0;">
																	<p style="line-height: 24px; margin: 0;">
																		<a href="#" style="color: <?php echo $color; ?>; text-decoration: none;">
															...
															<tr>
																<td style="color: <?php echo $color; ?>; vertical-align: top; padding: 15px 15px 15px 0; border-top: 1px solid #ddd;">
																	<p style="line-height: 24px; margin: 0;">
																		FSpS
																	</p>
																</td>
																<td style="color: <?php echo $color; ?>; vertical-align: top; padding: 15px 0; border-top: 1px solid #ddd;">
																	<p style="line-height: 24px; margin: 0;">
																		<a href="#" style="color: <?php echo $color; ?>; text-decoration: none;">
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
												<tr><!-- pokud je tento řádek první musí mít vnitřní <td> padding-top 0px -->
													<td style="border-bottom: 1px solid #ddd; padding: 0 0 10px;">
														...
														<h3 style="font-size: 18px; line-height: 24px; font-family: Tahoma, Verdana, sans-serif; color: <?php echo $color; ?>; margin: 0 0 15px;">
															<a href="#" style="text-decoration: none; color: <?php echo $color; ?>;">
								...
								<table class="sk-block-table" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left;">
									<tr class="sk-block">
										<td class="sk-block" class="sk-pb40" style="padding: 0 0 60px;">
											<table class="sk-block-table" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:14px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: left; border-top: 3px solid <?php echo $color; ?>; background: #f2f4f8;">
												<tr class="sk-block">
													<td class="sk-block sk-pl20 sk-pr20" style="border: 0px; padding: 20px 30px 0;">
														<h3 style="font-size: 24px; line-height: 32px; font-family: Tahoma, Verdana, sans-serif; color: <?php echo $color; ?>; margin: 0 0 20px;">
												...
												<tr class="sk-calendar__row">
													<td class="sk-calendar__td sk-calendar__date" style="width: 70px; padding: 0 0 30px; vertical-align: top;">
														<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; padding:0; font-size:12px; font-family: Arial, Helvetica, sans-serif; width:100%; text-align: center; font-weight: bold;">
															<tr>
																<td style="background: <?php echo $color; ?>; color: #fff; padding: 0 5px;">
													...
													<td class="sk-calendar__td" style="padding: 0 0 30px 40px; color: #444; vertical-align: top;">
														<h3 style="font-size: 18px; line-height: 24px; font-family: Tahoma, Verdana, sans-serif; color: <?php echo $color; ?>; margin: 0 0 10px;">
															<a href="#" style="text-decoration: none; color: <?php echo $color; ?>;">
																Nadpis jine akce
															</a>
														</h3>
														<p style="margin: 0 0 20px; line-height: 24px;">
															...
															<a href="#" style="color: <?php echo $color; ?>;">
																Podrobnosti o akci &gt;
															</a>
														</p>
													</td>
																		...
																		<tr>
																			<td style="padding: 0 0 20px;">
																				<div><!--[if mso]>
																				  <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:32px;v-text-anchor:middle;width:140px;" strokecolor="<?php echo $color; ?>" strokeweight="2px" fillcolor="#ffffff">
																					<w:anchorlock/>
																					<center style="color:<?php echo $color; ?>;font-family:sans-serif;font-size:12px;text-transform: uppercase;">Více informací</center>
																				  </v:rect>
																				<![endif]--><a href="#" style="border:2px solid <?php echo $color; ?>;color:<?php echo $color; ?>;display:inline-block;font-family:sans-serif;font-size:12px;text-transform: uppercase;line-height:32px;text-align:center;text-decoration:none;width:140px;-webkit-text-size-adjust:none;mso-hide:all;">Více informací</a></div>
																			</td>
																		</tr>
																	</table>
																</td>
